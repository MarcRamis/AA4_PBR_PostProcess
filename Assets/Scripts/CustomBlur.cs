...
public sealed class BlurSettings : PostProcessEffectSettings
{
    [Range(0f, 1f), Tooltip("Intensity value")]
...
public class CustomBlur : PostProcessEffectRenderer<BlurSettings>//<T> is the setting type
{
